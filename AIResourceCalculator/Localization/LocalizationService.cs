...
public class LocalizationService : ILocalizationService
{
    private static readonly Dictionary<string, string> StringsUk = new()
    {
        ...
        ["val.cpu.increase"] = "Збільшіть vCPU з {0:F1} до щонайменше {1:F1} ядер",
        ["val.cpu.reduce"] = "Зменшіть vCPU з {0:F1} до ~{1:F1} ядер для економії",
        ...
        ["results.summaryNode"] = "• {0}× {1}: {2} vCPU / {3} GB RAM, диск {4} GB",
        ["results.summaryTotals"] = "Разом: {0} vCPU · {1} GB RAM · {2} GB диск · {3} IOPS",
        ["results.podRequests"] = "K8s: поди запитують {0} vCPU / {1} GB RAM (фізично провіжиняться вузли вище, з округленням + master/SQL)",
        ...
        ["disk.perfLine"] = "  • IOPS: {0}{1}, затримка ≤ {2} мс",
    ...
    private static readonly Dictionary<string, string> StringsEn = new()
    {
        ...
        ["val.cpu.increase"] = "Increase vCPU from {0:F1} to at least {1:F1} cores",
        ["val.cpu.reduce"] = "Reduce vCPU from {0:F1} to ~{1:F1} cores to save costs",
        ...
        ["results.summaryNode"] = "• {0}× {1}: {2} vCPU / {3} GB RAM, {4} GB disk",
        ["results.summaryTotals"] = "Total: {0} vCPU · {1} GB RAM · {2} GB disk · {3} IOPS",
        ["results.podRequests"] = "K8s: pods request {0} vCPU / {1} GB RAM (physical nodes above are provisioned with rounding + master/SQL)",
        ...
        ["disk.perfLine"] = "  • IOPS: {0}{1}, latency ≤ {2} ms",
